...
import com.mariomatejovic.masterSpringFramework.masterSpringFrameowk.model.Profile;
...
public class ProfileController {
    ...
    // @Valid @ModelAttribute(profile) + atribute name  spring mvc spravi validaciu s
    // Profile  variable a jej anotaciami nad kazdou variable
